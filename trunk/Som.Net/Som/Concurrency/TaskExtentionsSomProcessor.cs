...
{
    public class TaskExtentionsSomProcessor: ILearningProcessor
    {
        ...
        public TaskExtentionsSomProcessor(ILearningDataProvider learningDataProvider,
            INetwork network,
        ...
        public int FindBestMatchingNeuron(double[] dataVector)
        {
            ...
            //Parallel.For(0,Network.Neurons.Length, y => { }
